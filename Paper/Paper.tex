...
listeners, the ability to enrich a speaker's meaning in context is an
indispensable component of successful communication. For example,
listeners commonly enrich the meaning of the scalar item \emph{some} to
\emph{some but not all} in sentences like ``Alice ate some of the
...
speaker could have used (such as \emph{all}) and b) the relative
...
that Alice did not eat \emph{all} the cookies because it would have been
