...
```{r}
# Literal listener: Negative alts (e11)

# FOR SOME REASON THIS ISN'T PLOTTING
...
Figure XX shows plots model / human correlation for our three simulations. Alpha was tuned separately for each of these runs...


# General Discussion
By varying the type of scale representations available to our Bayesian model we tested the effects of scalar alternatives in scalar implicature. Model fit with human judgements was significantly improved by the inclusion of alternatives beyond the typical "strong" and "weak" scalar items. In fact, we found that both neutral and negative valenced scalar items contribute to human-like implicature generation within our framework.
