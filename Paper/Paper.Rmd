...
The two-alternatives condition included only the scalar pairs from @vantiel2014. The four-alternatives condition included the two scalar items plus the top two-alternatives generated for each scalar family by participants in Experiment 2. The five-alternatives condition included the four previous items plus one more neutral item chosen from those alternatives generated in Experiment 2. See Figure \ref{fig:allScalesTable} for the complete list of alternatives used in each model. 
...
Figure \ref{fig:exp2_altsPlot_likedLoved} shows an example alternative set for the scalar items *liked* and *loved* (combined). We expanded our alternative set from only entailment items (Experiments 1a, 3a) to four alternatives (Experiments 1b, 3b) by including the top two alternatives elicited for each scale in Experiment 2. For example, the top two alternatives for the *liked*/*loved* scale were *hated* and *disliked* and were included in four-alternatives model runs. Similarly, neutral items (e.g. *okay* in the *good*/*excellent* scalar family) were chosen from among the set of alternatives elicited in Experiment 2. Alternative set distributions for the other scalar families (e.g. *good*/*excellent*, *memorable*/*unforgettable*) were similarly long-tailed. See Figure \ref{fig:allScalesTable} for the complete list of alternatives we used from Experiment 2.
