...
Conditions were run sequentially. In each condition we recruited 30 participants from Amazon Mechanical Turk (AMT). In the two-alternatives condition (Experiment 1a), `r 30 - length(unique(exp1a$workerid))` participants were excluded for either failing to pass two training trails or were not native English speakers, leaving a total sample of `r length(unique(exp1a$workerid))` participants.\footnote{The majority of respondent data excluded from the two-alternatives condition was caused by failure to pass training trials. We believe the task may have been too difficult for most respondents and made adjustments to the training trials in later conditions.} In the four alternative condition (Experiment 1b),  `r 30 - length(unique(exp1b$workerid))` participants were excluded for either failing to pass two training trials or were not native English speakers, leaving a total sample of `r length(unique(exp1b$workerid))` participants. In the five alternative condition (Experiment 1c), `r 30 - length(unique(exp1c$workerid))` participants were excluded for either failing to pass two training trials or were not native English speakers, leaving a total sample of `r length(unique(exp1c$workerid))`.
