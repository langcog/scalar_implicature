...
# Scalar matches between Full and partial
...
m3.noFit = data.full %>%
  do(run.full(., alpha = 1))
performance.output[5, ] = c("M3_noFit", round(cor(m3.noFit$listener.p, m3.noFit$pred)^2, 5))
...
performance.output[6, ] = c("M3_Fit", round(cor(m3.fit$listener.p, m3.fit$pred)^2, 5))
```
