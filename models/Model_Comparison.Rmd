...
# Store output
performance.output[1, ] = c("m1.a", round(cor(m1.a$listener.p, m1.a$pred), 5), T)
# Store plot
m1.a.plot = qplot(stars, e6.listener.p, col=degree, 
      data=m1.a,
      main=paste("m1.a\nalpha: ", alphas[1], "\nNormalized = ", T),
...
# Store output
performance.output[2, ] = c("m1.b", round(cor(m1.b$listener.p, m1.b$pred), 5), F)
# Store plot
m1.b.plot = qplot(stars, e6.listener.p, col=degree, 
      data=m1.b,
      main=paste("m1.b\nalpha: ", alphas[2], "\nNormalized = ", F),
      ylab="Posterior p(rating | word)") + 
  facet_wrap(~scale) + 
...
# Normalized = T
# alpha tune = T
alphas[3] = tune.alpha(data.partial, normalize=T)
m1.c = data.partial %>%
  do(run.partial(., alpha = alphas[3], useprior=T, usenone=F, normalize=T))
# Store output
performance.output[3, ] = c("m1.c", round(cor(m1.c$listener.p, m1.c$pred), 5), normalized=T)
# Store plot
m1.c.plot = qplot(stars, e6.listener.p, col=degree, 
      data=m1.c,
      main=paste("m1.c\nalpha: ", alphas[3], "\nNormalized = ", T),
      ylab="Posterior p(rating | word)") + 
  facet_wrap(~scale) + 
...
# Store output
performance.output[4, ] = c("m1.d", round(cor(m1.d$listener.p, m1.d$pred), 5), normalized=F)
# Store plot
m1.d.plot = qplot(stars, e6.listener.p, col=degree, 
      data=m1.d,
      main=paste("m1.d\nalpha: ", alphas[4], "\nNormalized = ", F),
      ylab="Posterior p(rating | word)") + 
  facet_wrap(~scale) + 
...
# Store output
performance.output[5, ] = c("m2.a", round(cor(m2.a$listener.p, m2.a$pred), 5), T)
# Store plot
m2.a.plot = qplot(stars, e6.listener.p, col=degree, 
      data=m2.a,
      main=paste("m2.a\nalpha: ", alphas[5], "\nNormalized = ", T),
      ylab="Posterior p(rating | word)") + 
  facet_wrap(~scale) + 
...
alphas[6] = 1
m2.b = data.partial %>%
  do(run.partial(., alpha = alphas[1], useprior=T, usenone=T, normalize=F))
# Store output
performance.output[6, ] = c("m2.b", round(cor(m2.b$listener.p, m2.b$pred), 5), F)
# Store plot
m2.b.plot = qplot(stars, e6.listener.p, col=degree, 
      data=m2.b,
      main=paste("m2.b\nalpha: ", alphas[6], "\nNormalized = ", F),
      ylab="Posterior p(rating | word)") + 
  facet_wrap(~scale) + 
...
# Normalized = T
# alpha tune = T
alphas[7] = tune.alpha(data.partial, normalize=T)
m2.c = data.partial %>%
  do(run.partial(., alpha = alphas[7], useprior=T, usenone=T, normalize=T))
# Store output
performance.output[7, ] = c("m2.c", round(cor(m2.c$listener.p, m2.c$pred), 5), normalized=T)
# Store plot
m2.c.plot = qplot(stars, e6.listener.p, col=degree, 
      data=m2.c,
      main=paste("m2.c\nalpha: ", alphas[3], "\nNormalized = ", T),
      ylab="Posterior p(rating | word)") + 
  facet_wrap(~scale) + 
...
# Store output
performance.output[8, ] = c("m2.d", round(cor(m2.d$listener.p, m2.d$pred), 5), normalized=F)
# Store plot
m2.d.plot = qplot(stars, e6.listener.p, col=degree, 
      data=m2.d,
      main=paste("m2.d\nalpha: ", alphas[8], "\nNormalized = ", F),
      ylab="Posterior p(rating | word)") + 
  facet_wrap(~scale) + 
...
# Store output
performance.output[9, ] = c("m3.a", round(cor(m3.a.matched$e6.listener.p, m3.a.matched$pred), 5), T)
# Store plot
...
# Store output
performance.output[10, ] = c("m3.b", round(cor(m3.b.matched$e6.listener.p, m3.b.matched$pred), 5), F)
# Store plot
...
# Store output
performance.output[11, ] = c("m3.c", round(cor(m3.c.matched$e6.listener.p, m3.c.matched$pred), 5), T)
# Store plot
...
# Store output
performance.output[12, ] = c("m3.d", round(cor(m3.d.matched$e6.listener.p, m3.d.matched$pred), 5), F)
# Store plot
...
# Store output
performance.output[13, ] = c("m4.a", round(cor(m4.a.matched$e6.listener.p, m4.a.matched$pred), 5), T)
# Store plot
...
# Store output
performance.output[14, ] = c("m4.b", round(cor(m4.b.matched$e6.listener.p, m4.b.matched$pred), 5), F)
# Store plot
...
# Store output
performance.output[15, ] = c("m4.c", round(cor(m4.c.matched$e6.listener.p, m4.c.matched$pred), 5), T)
# Store plot
m4.c.plot = qplot(stars, e6.listener.p, col=degree, 
      data=m4.c.matched,
      main=paste("m4.c\nalpha: ", alphas[15], "\nNormalized = ", T),
      ylab="Posterior p(rating | word)") + 
  facet_wrap(~scale) + 
...
# Store output
performance.output[16, ] = c("m4.d", round(cor(m4.d.matched$e6.listener.p, m4.d.matched$pred), 5), F)
# Store plot
