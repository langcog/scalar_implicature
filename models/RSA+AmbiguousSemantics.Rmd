...
<center>
<img src="RSA+AmbiguousSemantics_Images/e11_example.png" alt="Pragmatic Listener example" style="width: 500px;" align="middle" border="2"/>
</center>
```{r}
#![alt text](RSA+AmbiguousSemantics_Images/e11_example.png)
```
