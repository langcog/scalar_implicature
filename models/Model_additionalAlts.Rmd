...
# eta           --> 
# normalize     --> 
fit_distr = function(target, numIters = 100, eta=0.01,  normalize=F, alpha=1, verbose=F) {
  # Initialize to uniform
  w = rep(0.1, 5)
  # Focus on scalar 'target'
  scalar.focused = data.full.extras[data.full.extras$scale == target, ]
  # Initialize 'mid' alternative
  
  match.scalars = which(scalar.focused$degree == "hi1" | scalar.focused$degree == "hi2")
